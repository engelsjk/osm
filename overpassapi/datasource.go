// Package overpassapi provides an interface to the Overpass API.
package overpassapi
...
//		// 10 qps
//		overpassapi.DefaultDatasource.Limiter = rate.NewLimiter(10, 1)
...
func (e *NotFoundError) Error() string {
	return fmt.Sprintf("overpassapi: not found at %s", e.URL)
}
...
func (e *ForbiddenError) Error() string {
	return fmt.Sprintf("overpassapi: forbidden at %s", e.URL)
}
...
func (e *GoneError) Error() string {
	return fmt.Sprintf("overpassapi: gone at %s", e.URL)
}
...
func (e *RequestURITooLongError) Error() string {
	return fmt.Sprintf("overpassapi: uri too long at %s", e.URL)
}
...
func (e *UnexpectedStatusCodeError) Error() string {
	return fmt.Sprintf("overpassapi: unexpected status code of %d for url %s", e.Code, e.URL)
}
